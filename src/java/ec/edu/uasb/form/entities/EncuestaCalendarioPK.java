...
public class EncuestaCalendarioPK implements Serializable {
    ...
    public EncuestaCalendarioPK(Long anio, Long ciclo, Long codigoMateria, Long codigoEncuesta, Long codigoProfesor, Long codigoEsp,
            long codEstudiante, Long codigoNivel, Long codigoParalelo) {
        this.anio = anio;
        this.ciclo = ciclo;
    ...
    public int hashCode() {
        int hash = 7;
        hash = 61 * hash + (this.anio != null ? this.anio.hashCode() : 0);
        hash = 61 * hash + (this.ciclo != null ? this.ciclo.hashCode() : 0);
        hash = 61 * hash + (this.codigoMateria != null ? this.codigoMateria.hashCode() : 0);
        hash = 61 * hash + (this.codigoEncuesta != null ? this.codigoEncuesta.hashCode() : 0);
        hash = 61 * hash + (this.codigoProfesor != null ? this.codigoProfesor.hashCode() : 0);
        hash = 61 * hash + (this.codigoEsp != null ? this.codigoEsp.hashCode() : 0);
        hash = 61 * hash + (this.codEstudiante != null ? this.codEstudiante.hashCode() : 0);
        hash = 61 * hash + (this.codigoNivel != null ? this.codigoNivel.hashCode() : 0);
        hash = 61 * hash + (this.codigoParalelo != null ? this.codigoParalelo.hashCode() : 0);
        return hash;
    }
