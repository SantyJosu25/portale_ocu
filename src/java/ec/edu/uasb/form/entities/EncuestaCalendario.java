...
@NamedQueries({
    ...
    @NamedQuery(name = "EncuestaCalendario.findByCodigoEncuesta", query = "SELECT distinct e FROM EncuestaCalendario e WHERE e.encuestaCalendarioPK.codigoEncuesta = :codigoEncuesta"),
