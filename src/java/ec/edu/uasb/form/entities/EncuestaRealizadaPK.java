...
public class EncuestaRealizadaPK implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 53 * hash + (this.codigoAlumno != null ? this.codigoAlumno.hashCode() : 0);
        ...
        hash = 53 * hash + (this.codigoEncuesta != null ? this.codigoEncuesta.hashCode() : 0);
        hash = 53 * hash + (this.codigoProfesor != null ? this.codigoProfesor.hashCode() : 0);
        hash = 53 * hash + (this.codigoEsp != null ? this.codigoEsp.hashCode() : 0);
        hash = 53 * hash + (this.tipoRegistro != null ? this.tipoRegistro.hashCode() : 0);
        hash = 53 * hash + (this.codigoParalelo != null ? this.codigoParalelo.hashCode() : 0);
        return hash;
    }
