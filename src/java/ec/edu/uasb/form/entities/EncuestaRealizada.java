...
public class EncuestaRealizada implements Serializable {
    ...
    public EncuestaRealizada(Long codigoAlumno, Long anio, Long ciclo, Long codigoMateria, Long codigoEncuesta, Long codigoProfesor, Long codigoEsp,
            Long codigoNivel, Long codigoParalelo) {
        this.encuestaRealizadaPK = new EncuestaRealizadaPK(codigoAlumno, anio, ciclo, codigoMateria, codigoEncuesta, codigoProfesor, "A", codigoEsp,
                codigoNivel,codigoParalelo);
    }
