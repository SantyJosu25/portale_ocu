 ...
 */
@Embeddable
public class ParticipacionCeremGradDispoPK implements Serializable {
    ...
    public ParticipacionCeremGradDispoPK() {
    }

    public ParticipacionCeremGradDispoPK(Long codigoEncuesta, Long anio, Long codigoEsp, Long codigoNivel, Long codigoParalelo,Long tstCodigo) {
        this.codigoEncuesta = codigoEncuesta;
        this.anio = anio;
        this.codigoEsp = codigoEsp;
        this.codigoNivel = codigoNivel;
    ...
    public boolean equals(Object obj) {
        ...
        final ParticipacionCeremGradDispoPK other = (ParticipacionCeremGradDispoPK) obj;
