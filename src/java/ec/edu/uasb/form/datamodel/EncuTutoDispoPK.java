 ...
 */
@Embeddable
public class EncuTutoDispoPK implements Serializable {
    ...
    public EncuTutoDispoPK() {
    }

    public EncuTutoDispoPK(Long codigoEncuesta, Long anio, Long codigoEsp, Long codigoNivel, Long codigoParalelo,Long tstCodigo) {
        this.codigoEncuesta = codigoEncuesta;
        this.anio = anio;
        this.codigoEsp = codigoEsp;
        this.codigoNivel = codigoNivel;
        this.codigoParalelo = codigoParalelo;
        this.tstCodigo=this.tstCodigo;
    }
    ...
    public int hashCode() {
        ...
        hash = 71 * hash + (this.tstCodigo != null ? this.tstCodigo.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final EncuTutoDispoPK other = (EncuTutoDispoPK) obj;
        ...
        if (this.codigoParalelo != other.codigoParalelo && (this.codigoParalelo == null || !this.codigoParalelo.equals(other.codigoParalelo))) {
         ...
         if (this.tstCodigo != other.tstCodigo && (this.tstCodigo == null || !this.tstCodigo.equals(other.tstCodigo))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return codigoEncuesta + "-" + anio + ";" + codigoEsp + ":" + codigoNivel + "_" + codigoParalelo + "_" + tstCodigo;
    }
}
