...
public class PreguntaFacade extends AbstractFacade<Pregunta> implements PreguntaFacadeLocal {
    ...
    public List<Pregunta> findByEncuesta(long encuesta) {
        ...
        sb.append("FROM EVALUACION.PREGUNTA WITH (NOLOCK) WHERE CODIGO_ENCUESTA = ? and PREGUNTA_PADRE IS NULL ");
        sb.append("UNION ALL ");
        ...
        sb.append("FROM EVALUACION.PREGUNTA e WITH (NOLOCK) INNER JOIN PREGUNTA_CTE pcte ON  e.PREGUNTA_PADRE =  pcte.CODIGO_PREGUNTA ");
