 ...
 * @author victor.barba
 */
@ManagedBean(name = "evalTutorForm")
@ViewScoped
public class EvalTutorFormJSFManagedBean implements Serializable {
     ...
     */
public EvalTutorFormJSFManagedBean() {
    ...
    public void init() {
        ...
        catalogo = encuestaRealizadaFacade.encuestasDisponibles(codAlumno, matri.getAnio(), "EVAL_TUTORIA");
...
//                        System.out.println(" dynaFormControl." + dynaFormControl.getKey() + " dynaFormControl.getRow() " + dynaFormControl.getRow() + " ff.getValue() " + ff.getValue() + "  " + dynaFormControl.getType());
                        ...
                        respPK.setCodigoProfesor(encuProgDispo.getCodigoProfesor());
                        ...
                        respPK.setCodigoParalelo(encuProgDispo.getEncuProgDispoPK().getCodigoParalelo());
