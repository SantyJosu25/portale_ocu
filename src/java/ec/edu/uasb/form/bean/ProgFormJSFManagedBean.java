...
@ViewScoped
public class ProgFormJSFManagedBean implements Serializable {
    ...
    public void init() {
        ...
        catalogo = encuestaRealizadaFacade.encuestasDisponibles(codAlumno, matri.getAnio(), "EVAL_PROGRAMA");
...
//                    System.out.println(" dynaFormControl."+dynaFormControl.getKey()+" dynaFormControl.getRow() " + dynaFormControl.getRow() + " ff.getValue() " + ff.getValue() + "  " + dynaFormControl.getType());
                        ...
                        respPK.setCodigoProfesor(new Long("-1"));
                        respPK.setCodigoPregunta(((Pregunta) ff.getKey()).getPreguntaPK().getCodigoPregunta());
                        respPK.setCodigoEsp(encuProgDispo.getEncuProgDispoPK().getCodigoEsp());
