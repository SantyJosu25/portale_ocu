...
public class Usuario implements Serializable {
    ...
    public Usuario(Long usuCodigo, String usuCedPass, String usuNombreUsuario, String usuClave, String usuEmail, String usuLdap, String dn) {
        this.usuCodigo = usuCodigo;
    ...
    public String toString() {
        return "Usuario{" + "usuCodigo=" + usuCodigo + ", usuCedPass=" + usuCedPass + ", usuNombreUsuario=" + usuNombreUsuario + ", usuApellUsuario=" + usuApellUsuario + ", usuClave=" + usuClave + ", usuEmail=" + usuEmail + ", usuLdap=" + usuLdap + ", dn=" + dn + ", usuFechaUltimoLogin=" + usuFechaUltimoLogin + ", usuEstadoUsuario=" + usuEstadoUsuario + ", loginStatus=" + loginStatus + '}';
    }
